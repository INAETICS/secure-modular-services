...
public final class RemoteServiceAdminImpl extends AbstractComponentDelegate implements RemoteServiceAdmin {
     ...
     */
    private String[] getCheckedExportedInterfaces(Map<String, ?> exportProperties) {
     ...
     */
    private static Map<String, Object> getMergedProperties(ServiceReference<?> reference,
        Map<String, ?> extraProperties) {
