...
/**
 * Provides a {@link ServiceFactory} that creates a real
 * {@link HttpAvroClientEndpoint} for each bundle that is getting the service.
 *
...
public class HttpClientEndpointFactory implements ServiceFactory<Object>, ClientEndpointProblemListener {
     ...
     */
    public HttpClientEndpointFactory(final URL serviceURL, final List<String> interfaceNames,
    ...
    public Object getService(final Bundle bundle, final ServiceRegistration<Object> registration) {
        ...
        HttpAvroClientEndpoint restEndpoint = new HttpAvroClientEndpoint(m_serviceURL, m_configuration,
            interfaceClasses);
    ...
    @Override
    public synchronized void handleEndpointError(final Throwable exception) {
    ...
    @Override
    public synchronized void handleEndpointWarning(final Throwable exception) {
        if (m_problemListener != null) {
     ...
     */
    public synchronized void setProblemListener(final ClientEndpointProblemListener problemListener) {
        m_problemListener = problemListener;
    }

    @Override
    public void ungetService(final Bundle bundle, final ServiceRegistration<Object> registration,
