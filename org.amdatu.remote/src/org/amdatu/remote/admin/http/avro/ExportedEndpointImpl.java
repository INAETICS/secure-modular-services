...
public final class ExportedEndpointImpl implements ExportRegistration, ExportReference, ServerEndpointProblemListener {
    ...
    private volatile HttpAvroServerEndpoint m_serverEndpoint;
     ...
     */
    public ExportedEndpointImpl(final RemoteServiceAdminImpl admin, final EndpointDescription description,
        final ServiceReference<?> reference, final Map<String, ?> properties,
        final HttpAvroServerEndpoint serverEndpoint) {
    ...
    @Override
    public EndpointDescription update(final Map<String, ?> properties) {
        if (m_closed.get()) {
    ...
    void close(boolean ignoreClosed) {
        ...
        HttpAvroServerEndpoint serverEndpoint = m_serverEndpoint;
    ...
    EndpointDescription getExportedEndpoint(final boolean ignoreClosed) {
