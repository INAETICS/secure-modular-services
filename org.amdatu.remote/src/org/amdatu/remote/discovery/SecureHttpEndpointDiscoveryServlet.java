...
import static org.amdatu.remote.SecureEndpointUtil.writeEndpoints;
 ...
 */
public final class SecureHttpEndpointDiscoveryServlet<T extends HttpEndpointDiscoveryConfiguration> extends HttpServlet {
    ...
    public SecureHttpEndpointDiscoveryServlet(AbstractDiscovery discovery, T configuration) {
    ...
    private void doGetEndpoints(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            writeEndpoints(out, m_configuration, m_endpointsArray);
        }
        finally {
            closeSilently(out);
        }
    ...
    protected void doGetEndpoint(HttpServletRequest req, HttpServletResponse resp, String endpointId)
        ...
        try {
            out = new OutputStreamWriter(resp.getOutputStream());
            writeEndpoints(out, m_configuration, endpoint);
        }
        finally {
            closeSilently(out);
        }
