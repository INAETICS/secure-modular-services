...
public class Activator extends AbstractAttributeBasedEncryptionActivator implements HttpEndpointDiscoveryConfiguration, ManagedService {

    public static final String CONFIG_PID = "org.amdatu.remote.discovery.bonjour";
    ...
    public void init(BundleContext context, DependencyManager manager) throws Exception {
        ...
        int schedule = getConfigIntValue(m_context, CONFIG_SCHEDULE_KEY, null, 10);
    ...
    public void updated(Dictionary<String, ?> properties) throws ConfigurationException {
        ...
        try {
            ...
            if (!baseUrl.equals(m_baseUrl) || m_schedule != schedule) {
                unregisterDiscoveryService();
                m_baseUrl = baseUrl;
                m_schedule = schedule;
                registerDiscoveryService();
    ...
    private void registerDiscoveryService() {
        ...
        Properties properties =
            createEndpointListenerServiceProperties(m_manager.getBundleContext(),
                BonjourEndpointDiscovery.DISCOVERY_TYPE);

        BonjourEndpointDiscovery discovery = new BonjourEndpointDiscovery(this);
