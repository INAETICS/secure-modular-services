...
import org.amdatu.remote.admin.http.avro.HttpAdminConstants;
...
public class RSAImportTest extends AbstractRemoteServiceAdminTest {
    ...
    protected void doTestRsaImportReturnsNullForUnavailableClasses() throws Exception {
        ...
        properties.put(Constants.OBJECTCLASS,
            new String[] { EchoInterface.class.getName(), "no.such.class.available" });
        description = new EndpointDescription(properties);
        registration = m_remoteServiceAdmin.importService(description);
        assertNull("Expected null registration for unavailable class", registration);
    }
    ...
    protected void doTestRsaImportProperties() throws Exception {
        ...
        properties.put("endpoint.package." + EchoInterface.class.getPackage().getName(),
            packageVersion);
        properties.put(SERVICE_IMPORTED_CONFIGS, CONFIGURATION_TYPE);
        properties.put(SERVICE_INTENTS, new String[] { "passByValue" });
        properties.put(ENDPOINT_URL, "http://bla");
        ...
        try {
            ...
            assertEquals(
                "Service Property endpoint.package." + EchoInterface.class.getPackage().getName()
                    + " must be set correctly",
                packageVersion,
                serviceReference.getProperty(
                    "endpoint.package." + EchoInterface.class.getPackage().getName()));
            ...
            assertEquals("Service Property " + ENDPOINT_URL + " must be set correctly", "http://bla",
                serviceReference.getProperty(ENDPOINT_URL));
    ...
    protected void doTestRsaImportConfigurationChanged() throws Exception {
        ...
        try {
            ...
            getChildContext().configure(HttpAdminConstants.SERVICE_PID, HttpAdminConstants.PATH_CONFIG_KEY, "qqq");
