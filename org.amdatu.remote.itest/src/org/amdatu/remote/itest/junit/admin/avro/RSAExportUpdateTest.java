...
public class RSAExportUpdateTest extends AbstractRemoteServiceAdminTest {
    ...
    protected void doTestExportUpdateSimpleSuccess() throws Exception {
        ...
        ServiceRegistration<?> serviceRegistration = getChildBundleContext().registerService(
            EchoInterface.class.getName(), mock(EchoInterface.class),
            serviceProperties);

        Map<String, Object> extraProperies = new HashMap<String, Object>();
        extraProperies.put("some.property", "123");

        Collection<ExportRegistration> exportRegistrations = m_remoteServiceAdmin
            .exportService(serviceRegistration.getReference(), extraProperies);
        ...
        assertNull("Expected some property to be unset", endpointDescription.getProperties().get("some.property"));
    ...
    protected void doTestExportUpdateFailsOnInvalidConfigType() throws Exception {
        ...
        // assertNotNull("Expected exception to be set",
